...
DCF window $\mathrm{CW}_0$ / $\mathrm{CW}_{\max}$ & $15$ / $1023$ \\
% Collision cost $L_\mathrm{col}(t)$ & $\max_{i\in\mathcal{D}(t)} L_i$ (basic) / eq.~\eqref{eq:coll_rts} (RTS/CTS) \\
...
eq.~\eqref{eq:lmax}. We compare PACE against standard DCF with BEB, the open-loop AND schedule~\cite{vasudevan2013efficient}, and an oracle
