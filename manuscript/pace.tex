...
We consider a single Basic Service Set (BSS) comprising an Access Point (AP) and a set $\mathcal{N}=\{1,2,\dots,N\}$ of associated non-AP stations that operate under IEEE 802.11bn. Following the NPCA capability requirement, the BSS occupies a wide operating channel of at least $80$~MHz. The operating channel is partitioned into a \emph{BSS primary channel} and a secondary portion of one or more $20$~MHz subchannels. Within the secondary portion the AP designates one
...
primary channel, consistent with the terminology of P802.11bn Draft~\cite{ieee80211bn}.
